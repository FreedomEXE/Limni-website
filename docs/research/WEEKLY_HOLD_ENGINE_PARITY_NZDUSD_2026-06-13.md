# Weekly Hold Engine Parity Research - NZDUSD
...
This note records the Dealer Weekly Hold parity target for NZDUSD. The goal is
...
```powershell
npm run verification:export-weekly-hold-runback -- --symbol NZDUSD --weeks 26 --from 2026-01-01 --derive-missing-execution
```

Receipt files:

- JSON: `app/reports/data-verification/weekly-hold-runback/nzdusd-dealer-weekly-hold-23w-20260613-220648.json`
- CSV: `app/reports/data-verification/weekly-hold-runback/nzdusd-dealer-weekly-hold-23w-20260613-220648.csv`
- Markdown: `app/reports/data-verification/weekly-hold-runback/nzdusd-dealer-weekly-hold-23w-20260613-220648.md`
- Pine input: `app/reports/data-verification/weekly-hold-runback/nzdusd-dealer-weekly-hold-23w-20260613-220648-pine-input.txt`
...
- Rows: 23.
- Direction rows: 23.
- Wins/losses/flat: 11/12/0.
- Total raw percent: -3.468818%.
- Total app ADR-normalized percent: -6.668698%.
- Max raw DD percent: -3.306599%.
- Max app ADR DD percent: -4.783056%.
- Avg raw DD percent: -1.171060%.
- Avg app ADR DD percent: -1.324712%.
- Worst DD week: displayed 2026-01-20.
...
NZDUSD is PASS because the corrected TradingView screenshot proves:

- `OANDA:NZDUSD` is the active feed.
