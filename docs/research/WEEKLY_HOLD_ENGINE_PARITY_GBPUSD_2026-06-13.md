# Weekly Hold Engine Parity Research - GBPUSD
...
This note records the Dealer Weekly Hold parity target for GBPUSD. The goal is
not strategy tuning. The goal is to prepare a reproducible app-side receipt and
TradingView/Pine smoke test for return and drawdown parity.
...
```powershell
npm run verification:export-weekly-hold-runback -- --symbol GBPUSD --weeks 26 --from 2026-01-01 --derive-missing-execution
```

Receipt files:

- JSON: `app/reports/data-verification/weekly-hold-runback/gbpusd-dealer-weekly-hold-23w-20260613-215954.json`
- CSV: `app/reports/data-verification/weekly-hold-runback/gbpusd-dealer-weekly-hold-23w-20260613-215954.csv`
- Markdown: `app/reports/data-verification/weekly-hold-runback/gbpusd-dealer-weekly-hold-23w-20260613-215954.md`
- Pine input: `app/reports/data-verification/weekly-hold-runback/gbpusd-dealer-weekly-hold-23w-20260613-215954-pine-input.txt`
...
- Rows: 23.
- Direction rows: 23.
- Wins/losses/flat: 12/11/0.
- Total raw percent: -1.686418%.
- Total app ADR-normalized percent: -2.480638%.
- Max raw DD percent: -2.262972%.
- Max app ADR DD percent: -3.155071%.
- Avg raw DD percent: -0.836550%.
- Avg app ADR DD percent: -1.188188%.
...
GBPUSD is PASS because the corrected TradingView screenshot proves:

- `OANDA:GBPUSD` is the active feed.
