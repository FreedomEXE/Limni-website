...
Generated: `2026-07-04T01:16:40.715Z`
...
- Activation rules: `triangle_formulaic_directionless_geometry_v2_floorpin`.
...
| marginal_add_audit_rows | Gate 91F direct-fill marginal audit rows emitted for actually opened adverse adds on the v2.1 floor-pin baseline; rows measure the candidate fill's own future PnL, swap, commission, net USD, and without-this-fill target eligibility at the actual close mark |
| candidate_direct_net_usd | candidate adverse fill's direct contribution at the eventual cycle close mark: fill price PnL in USD plus fill swap plus the entry commission assigned to that fill |
| without_candidate_target_eligible_at_actual_close | diagnostic boolean asking whether the remaining basket, with only this candidate fill removed, would still satisfy the selected target condition at the actual close mark; this is not a full branch-and-replay counterfactual |
...
| activation_rule_ids | triangle_formulaic_directionless_geometry_v2_floorpin | explicit | true |
...
| triangle_formulaic_v2_3_enabled | false | true when activation_rule_ids includes a v2.3 add-throttle rule | true |
| triangle_formulaic_v2_3_add_gate |  | v2.3 applies no-feed gates to adverse adds only | true |
| triangle_formulaic_v2_3_receipts |  | visible when v2.3 add-throttle rules are enabled | true |
| gate91f_marginal_add_audit_receipts | marginal-add-audit.rows direct-fill contribution audit | visible when v2.1 floor-pin baseline is replayed | true |
| gate91f_counterfactual_boundary | direct-fill marginal value plus without-fill actual-close target eligibility; not full branch replay | diagnostic-only causal boundary is explicit | true |
...
- summaryJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/close-events.rows.csv`
- addThrottleEventsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/add-throttle-events.rows.json`
- addThrottleEventsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/add-throttle-events.rows.csv`
- marginalAddAuditJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/marginal-add-audit.rows.json`
- marginalAddAuditCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/marginal-add-audit.rows.csv`
- closeEventBreakdownsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/close-event-breakdown.rows.json`
- closeEventBreakdownsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/close-event-breakdown.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-smoke-audchf-2019-1w/GATE91F_MARGINAL_ADD_AUDIT_SMOKE_AUDCHF_2019_1W.md`
