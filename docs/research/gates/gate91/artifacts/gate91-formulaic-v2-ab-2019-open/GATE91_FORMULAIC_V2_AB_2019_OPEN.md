...
Generated: `2026-07-03T20:54:50.442Z`
...
- summaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/close-events.rows.csv`
- closeEventBreakdownsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/close-event-breakdown.rows.json`
- closeEventBreakdownsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/close-event-breakdown.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/validation.rows.json`
- validationCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-ab-2019-open/GATE91_FORMULAIC_V2_AB_2019_OPEN.md`
