...
Generated: `2026-07-03T20:49:00.114Z`
...
| RAW_GRID_T100_S020_GATE90_TRIANGLE_FORMULAIC_DIRECTIONLESS_GEOMETRY_V2__PROTECT_PAIN_1Q_STOP_ADDS_BEFORE_PROFIT_0_5Q | triangle_formulaic_directionless_geometry_v2 | pain_1q_stop_adds_before_profit_0_5q | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCHF | open | m1 | 0.1 | ny_daily_window | 18:05 | 15:45 | 16:00 | 20:00 | session_center_band_reversion | 1 | 0.2 | 0 | adverse_only | 1 | 1 | 10026.22 | 26.22 | 29.24 | 0 | -2.52 | -0.5 | 6 | 6 | -5.3 | 0 | 0 | 0 | 42 | 0 | 11 | 10 | 0 |  | 27 | 5.554794 | 81.48 | 5.711655 | 5.711655 | 4.058521 | 0.211543 | 0.150316 | 0.252706 | 0.239533 | 0.179565 | 0.170205 | 55.56 | 25.93 | 22.22 | 44.44 | 33.33 | 18.52 | 31.89 | -5.66 | 0 | 11 | 16 | 3769 | 2634 | 4223 | 0.29 | 0.6 | false |
...
- summaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/close-events.rows.csv`
- closeEventBreakdownsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/close-event-breakdown.rows.json`
- closeEventBreakdownsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/close-event-breakdown.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate91/artifacts/gate91-formulaic-v2-smoke-audchf-2019-1w/GATE91_FORMULAIC_V2_SMOKE_AUDCHF_2019_1W.md`
