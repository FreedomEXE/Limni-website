...
Generated: `2026-07-03T19:42:56.227Z`
...
- Variants: `RAW_GRID_T100_S020_GATE90_TRIANGLE_FORMULAIC_DIRECTIONLESS_GEOMETRY,RAW_GRID_T100_S020_GATE90_TRIANGLE_FORMULAIC_DIRECTIONLESS_GEOMETRY__PROTECT_PAIN_1Q_STOP_ADDS_BEFORE_PROFIT_0_5Q`.
- Activation rules: `triangle_formulaic_directionless_geometry`.
...
- Gate 91 formulaic geometry id: `gate91_formulaic_directionless_grid_geometry_scaffold_2026_07_03`; directionless first pass, no Candidate B or David side dependency.
- Gate 91 Q equation: `Q = max(R / (2 + 2 * (1 - PE)), C)`, with cost floor `0.05` ADR, PE reject threshold `0.35`, signal event brick `Q / 4`, and session-mid reversion target receipts.
...
- Target mode `session_mid_reversion`, fixed target `1` ADR used only by fixed_adr mode, spacing `0.2` ADR, minimum MA expansion `0` ADR, grid add mode `adverse_only`, lot size `0.01`.
...
- Target resets use the selected target mode. fixed_adr uses price ADR PnL; david_ma_reversion closes only profitable returns to the current David MA; session_mid_reversion closes only profitable returns to the formulaic session midpoint.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_TRIANGLE_FORMULAIC_DIRECTIONLESS_GEOMETRY | triangle_formulaic_directionless_geometry | baseline | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCHF | open | m1 | 0.1 | ny_daily_window | 18:05 | 15:45 | 16:00 | 20:00 | session_mid_reversion | 1 | 0.2 | 0 | adverse_only | 1 | 1 | 10010.01 | 10.01 | 11.71 | 0 | -1.56 | -0.14 | 4 | 14 | -5.16 | 0.05 | 0 | 0 | 26 | 0 | 6 | 5 | 0 |  | 12 | 2.471515 | 75 | 2.283964 | 2.283964 | 1.622913 | 0.19033 | 0.135243 | 0.438782 | 0.422089 | 0.311785 | 0.299923 | 83.33 | 25 | 16.67 | 33.33 | 25 | 25 | 15.96 | -5.95 | 0 | 5 | 7 | 4263 | 3107 | 5072 | 0.12 | 0.22 | false |
| RAW_GRID_T100_S020_GATE90_TRIANGLE_FORMULAIC_DIRECTIONLESS_GEOMETRY__PROTECT_PAIN_1Q_STOP_ADDS_BEFORE_PROFIT_0_5Q | triangle_formulaic_directionless_geometry | pain_1q_stop_adds_before_profit_0_5q | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCHF | open | m1 | 0.1 | ny_daily_window | 18:05 | 15:45 | 16:00 | 20:00 | session_mid_reversion | 1 | 0.2 | 0 | adverse_only | 1 | 1 | 10012.72 | 12.72 | 13.92 | 0 | -1.02 | -0.18 | 4 | 5 | -2.95 | 0.01 | 0 | 0 | 17 | 0 | 5 | 4 | 0 |  | 12 | 4.104607 | 75 | 2.717224 | 2.717224 | 1.930774 | 0.226435 | 0.160898 | 0.298447 | 0.235495 | 0.212067 | 0.167335 | 75 | 16.67 | 8.33 | 33.33 | 25 | 25 | 15.96 | -3.24 | 0 | 5 | 7 | 4263 | 3107 | 5072 | 0.12 | 0.22 | false |
...
| cycle_signal_adr_brick | per-cycle derived signal event brick; Gate 91 formulaic geometry sets it to Q/4 instead of using a fixed ADR-event brick |
| reversion_target_price | per-cycle non-David reversion target price; Gate 91 formulaic geometry uses the completed session midpoint |
| cycle_spacing_adr | actual ADR spacing assigned to the side cycle at start; triangle_v0/v1 use the Gate 90D adaptive spacing receipt, and Gate 91 formulaic geometry uses Q from range, path efficiency, and cost floor |
...
| target_reset_uses_selected_target_mode | session_mid_reversion | fixed_adr_or_david_ma_reversion_or_session_mid_reversion | true |
| target_mode | session_mid_reversion | explicit | true |
| target_adr | 1 | >0 | true |
...
| activation_rule_ids | triangle_formulaic_directionless_geometry | explicit | true |
...
| triangle_formulaic_enabled | true | true when activation_rule_ids includes triangle_formulaic_directionless_geometry | true |
| triangle_formulaic_id | gate91_formulaic_directionless_grid_geometry_scaffold_2026_07_03 | visible when the Gate 91 formulaic rule is enabled | true |
| triangle_formulaic_q_equation | Q=max(R/(2+2*(1-PE)),C) | range/path-efficiency/cost-floor equation | true |
| triangle_formulaic_signal_brick | Q/4 | derived from Q, not fixed ADR-event brick | true |
| triangle_formulaic_direction_policy | directionless_symmetric_long_short | no Candidate B or David direction dependency | true |
| triangle_formulaic_target | session_mid_reversion | session_mid_reversion | true |
...
- summaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/close-events.rows.csv`
- closeEventBreakdownsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/close-event-breakdown.rows.json`
- closeEventBreakdownsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/close-event-breakdown.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate91/artifacts/gate91-formulaic-smoke-audchf-2019-1w/GATE91_FORMULAIC_SMOKE_AUDCHF_2019_1W.md`
