...
Generated: `2026-07-04T01:21:48.418Z`
...
- summaryJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/close-events.rows.csv`
- addThrottleEventsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/add-throttle-events.rows.json`
- addThrottleEventsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/add-throttle-events.rows.csv`
- marginalAddAuditJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/marginal-add-audit.rows.json`
- marginalAddAuditCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/marginal-add-audit.rows.csv`
- closeEventBreakdownsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/close-event-breakdown.rows.json`
- closeEventBreakdownsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/close-event-breakdown.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/validation.rows.json`
- validationCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate91/artifacts/gate91f-marginal-add-audit-2019-open/GATE91F_MARGINAL_ADD_AUDIT_2019_OPEN.md`
