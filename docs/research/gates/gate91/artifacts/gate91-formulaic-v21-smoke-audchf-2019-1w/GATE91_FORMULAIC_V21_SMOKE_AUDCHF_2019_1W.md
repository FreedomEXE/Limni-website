...
Generated: `2026-07-03T22:14:13.611Z`
...
| RAW_GRID_T100_S020_GATE90_TRIANGLE_FORMULAIC_DIRECTIONLESS_GEOMETRY_V2_SURPLUS_CONVEX | triangle_formulaic_directionless_geometry_v2_surplus_convex | baseline | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCHF | open | m1 | 0.1 | ny_daily_window | 18:05 | 15:45 | 16:00 | 20:00 | session_center_band_reversion | 1 | 0.2 | 0 | adverse_only | 1 | 1 | 10006.47 | 6.47 | 7.96 | 0 | -1.44 | -0.05 | 3 | 6 | -4.41 | 0 | 0 | 0 | 24 | 0 | 3 | 2 | 0 |  | 16 | 2.331252 | 87.5 | 1.541461 | 1.541461 | 1.095313 | 0.096341 | 0.068457 | 0.153714 | 0.12571 | 0.109224 | 0.089325 | 56.25 | 37.5 | 31.25 | 43.75 | 25 | 18.75 | 11.24 | -4.77 | 0 | 6 | 10 | 4729 | 4252 | 2119 | 0.13 | 0.23 | false |
...
- summaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/close-events.rows.csv`
- closeEventBreakdownsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/close-event-breakdown.rows.json`
- closeEventBreakdownsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/close-event-breakdown.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate91/artifacts/gate91-formulaic-v21-smoke-audchf-2019-1w/GATE91_FORMULAIC_V21_SMOKE_AUDCHF_2019_1W.md`
