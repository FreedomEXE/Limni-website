...
Generated: `2026-07-03T00:44:59.516Z`
...
- Variants: `RAW_GRID_T100_S020_GATE90_TRIANGLE_V0,RAW_GRID_T100_S020_GATE90_RAW_BOTH,RAW_GRID_T100_S020_GATE90_DAVID_CONTRA,RAW_GRID_T100_S020_GATE90_CANDIDATE_B,RAW_GRID_T100_S020_GATE90_CANDIDATE_B_DAVID_CONTRA_CONFLICT_CANDIDATE`.
- Activation rules: `triangle_v0,raw_both,david_contra,candidate_b,candidate_b_david_contra_conflict_candidate`.
...
| activation_rule_ids | triangle_v0,raw_both,david_contra,candidate_b,candidate_b_david_contra_conflict_candidate | explicit | true |
| activation_controls_initial_cycle_start_only | true | true | true |
| triangle_v0_enabled | true | true only when activation_rule_ids includes triangle_v0 | true |
| triangle_v0_formula_id | gate90d_triangle_v0_katarakti_start_spacing_scaffold_2026_07_03 | visible when triangle_v0 is enabled | true |
| triangle_v0_spacing_rails_adr | 0.2..0.3 | range/3 clamped rails when triangle_v0 is enabled | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/close-events.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-compare-2026-26w-adr0025-ma25-s1/GATE90D_TRIANGLE_V0_COMPARE_2026_26W_ADR0025_MA25_S1.md`
