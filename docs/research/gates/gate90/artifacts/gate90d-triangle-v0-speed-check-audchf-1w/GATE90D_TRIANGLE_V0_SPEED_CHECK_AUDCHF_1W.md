...
Generated: `2026-07-03T02:20:33.549Z`
...
- Variants: `RAW_GRID_T100_S020_GATE90_TRIANGLE_V0`.
- Activation rules: `triangle_v0`.
...
| activation_rule_ids | triangle_v0 | explicit | true |
...
| selected_week_count | 207 | >=1 | true |
| selected_pair_count | 1 | >=1 | true |

## Artifacts

- summaryJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/close-events.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/artifacts/gate90d-triangle-v0-speed-check-audchf-1w/GATE90D_TRIANGLE_V0_SPEED_CHECK_AUDCHF_1W.md`
