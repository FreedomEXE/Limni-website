...
Generated: `2026-07-02T23:17:13.240Z`
...
- Variants: `RAW_GRID_T100_S020_GATE90_RAW_BOTH`.
- Activation rules: `raw_both`.
- Signal settings id: `DAVID_LWMA50_RSI50_60_40__STOCH_100_3_21_80_20_low_high_simple_main_only`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_RAW_BOTH | raw_both | DAVID_LWMA50_RSI50_60_40__STOCH_100_3_21_80_20_low_high_simple_main_only | EURUSD | ohlc_high_low | adr_event | 0.1 | ny_daily_window | 18:05 | 15:45 | 16:00 | 20:00 | david_ma_reversion | 1 | 0.2 | 0.1 | adverse_only | 1 | 1 | 9969.51 | -30.49 | -29.54 | 0 | -0.96 | 0.01 | 2 | 10 | -33.5 | -0.01 | 16 | 0 | 7 | 6 | -30.49 | 0 | 5 | 0.106316 | 60 | 3.63 | -34.11 | 1 | 4 | 22913 | 13444 | 36357 | 0 | 0.03 | false |
...
| activation_rule_ids | raw_both | explicit | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/close-events.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/artifacts/gate90d-start-trace-smoke/GATE90D_START_TRACE_SMOKE.md`
