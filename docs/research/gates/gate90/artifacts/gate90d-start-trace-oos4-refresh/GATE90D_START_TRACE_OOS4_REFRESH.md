...
Generated: `2026-07-02T23:31:10.401Z`
...
- summaryJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/close-events.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/artifacts/gate90d-start-trace-oos4-refresh/GATE90D_START_TRACE_OOS4_REFRESH.md`
