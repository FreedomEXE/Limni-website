...
Generated: `2026-07-02T09:50:23.281Z`
...
This was an initial smoke run and is saved only as a run receipt. It used the
default David/Stoch settings (`RSI21 80/20`, stochastic slowing `21`), not
Freedom's corrected David RSI `100/60/40` and Stoch `100/3/100` settings. Do
not use this report to compare David/Stoch against Candidate B.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_RAW_BOTH | raw_both | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCAD,AUDCHF,AUDJPY,AUDNZD,AUDUSD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,EURUSD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,GBPUSD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDCAD,USDCHF,USDJPY | ohlc_high_low | 5 | 28 | 11755 | 1755 | 5237.71 | -2784.54 | -277.62 | -420.56 | 4627 | 504 | 514 | 53 | 0 | 492 | 412 | 0 | 0 | 100 | 100 | true |
| RAW_GRID_T100_S020_GATE90_CANDIDATE_B | candidate_b | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCAD,AUDCHF,AUDJPY,AUDNZD,AUDUSD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,EURUSD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,GBPUSD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDCAD,USDCHF,USDJPY | ohlc_high_low | 5 | 28 | 10384.94 | 384.94 | 2717.37 | -1963.29 | -141.78 | -227.36 | 2363 | 287 | 287 | 53 | -772.98 | 253 | 209 | 1860550 | 1750564 | 0.01 | 0.01 | true |
| RAW_GRID_T100_S020_GATE90_DAVID_CONTRA | david_contra | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCAD,AUDCHF,AUDJPY,AUDNZD,AUDUSD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,EURUSD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,GBPUSD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDCAD,USDCHF,USDJPY | ohlc_high_low | 5 | 28 | 12221.79 | 2221.79 | 3743.07 | -1074.85 | -184.2 | -262.23 | 3070 | 242 | 267 | 25 | 0 | 336 | 288 | 1323896 | 1449448 | 0.03 | 0.02 | true |
| RAW_GRID_T100_S020_GATE90_DAVID_STOCH_RELEASE | david_stoch_release | DAVID_LWMA35_RSI21_80_20__STOCH_100_3_21_80_20_low_high_simple_main_only | AUDCAD,AUDCHF,AUDJPY,AUDNZD,AUDUSD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,EURUSD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,GBPUSD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDCAD,USDCHF,USDJPY | ohlc_high_low | 5 | 28 | 11626.96 | 1626.96 | 2893.77 | -910.97 | -141.54 | -214.3 | 2359 | 184 | 218 | 25 | 0 | 260 | 219 | 1685042 | 1828316 | 0.02 | 0.01 | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/quick-candidate-b-costed-4w-recent-ohlc/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_QUICK_CANDIDATE_B_COSTED_4W_RECENT_OHLC_2026-07-02.md`
