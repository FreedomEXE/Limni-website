...
Generated: `2026-07-02T10:32:37.434Z`
...
- Signal settings id: `DAVID_LWMA200_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only`.
- David MA settings: LWMA `200`, close price, RSI `100`, overbought `60`, oversold `40`.
...
- Target mode `david_ma_reversion`, fixed target `1` ADR, spacing `0.1` ADR, lot size `0.01`.
- Bar path mode: `close`.
...
| variant_id | activation_rule_id | signal_settings_id | symbol_universe | bar_path_mode | target_mode | target_adr | spacing_adr | weeks_replayed | pairs_replayed | final_balance_usd | net_profit_usd | closed_price_pnl_usd | end_liquidation_price_pnl_usd | total_commission_usd | total_swap_usd | entries_opened | end_liquidation_positions | max_open_positions | max_add_depth | max_equity_drawdown_usd | activation_started_long | activation_started_short | activation_blocked_long | activation_blocked_short | activation_long_allow_pct | activation_short_allow_pct | summary_only |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_RAW_BOTH | raw_both | DAVID_LWMA200_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only | AUDCAD | close | david_ma_reversion | 1 | 0.1 | 1 | 1 | 9710.66 | -289.34 | 69.66 | -315.11 | -43.5 | -0.39 | 725 | 39 | 40 | 35 | -289.34 | 428 | 146 | 0 | 0 | 100 | 100 | true |
| RAW_GRID_T100_S020_GATE90_DAVID_CONTRA | david_contra | DAVID_LWMA200_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only | AUDCAD | close | david_ma_reversion | 1 | 0.1 | 1 | 1 | 9838.21 | -161.79 | 28.36 | -170.85 | -19.44 | 0.14 | 324 | 27 | 27 | 26 | -161.79 | 184 | 61 | 3855 | 1736 | 4.56 | 3.39 | true |
| RAW_GRID_T100_S020_GATE90_DAVID_STOCH_RELEASE | david_stoch_release | DAVID_LWMA200_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only | AUDCAD | close | david_ma_reversion | 1 | 0.1 | 1 | 1 | 10002.34 | 2.34 | 3.49 | -0.24 | -0.9 | -0.01 | 15 | 1 | 3 | 2 | 0 | 4 | 8 | 6402 | 6451 | 0.06 | 0.12 | true |
...
| david_ma_settings | LWMA200_RSI100_60_40 | explicit CLI/default settings | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/smoke-ma200-target-audcad-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_SMOKE_MA200_TARGET_AUDCAD_1W_2026-07-02.md`
