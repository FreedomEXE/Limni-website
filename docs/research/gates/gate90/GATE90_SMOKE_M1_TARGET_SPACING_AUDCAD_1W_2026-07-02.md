...
Generated: `2026-07-02T10:17:04.422Z`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_RAW_BOTH | raw_both | DAVID_LWMA35_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only | AUDCAD | close | 0.1 | 0.05 | 1 | 1 | 9493.75 | -506.25 | 138.19 | -610.61 | -33.12 | -0.71 | 552 | 76 | 78 | 69 | -506.25 | 109 | 43 | 0 | 0 | 100 | 100 | true |
| RAW_GRID_T100_S020_GATE90_DAVID_CONTRA | david_contra | DAVID_LWMA35_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only | AUDCAD | close | 0.1 | 0.05 | 1 | 1 | 9708.66 | -291.34 | 59.95 | -335.49 | -16.14 | 0.34 | 269 | 53 | 53 | 52 | -291.34 | 54 | 15 | 3854 | 1570 | 1.38 | 0.95 | true |
| RAW_GRID_T100_S020_GATE90_DAVID_STOCH_RELEASE | david_stoch_release | DAVID_LWMA35_RSI100_60_40__STOCH_100_3_100_80_20_low_high_simple_main_only | AUDCAD | close | 0.1 | 0.05 | 1 | 1 | 10009.92 | 9.92 | 12.6 | -0.13 | -2.52 | -0.03 | 42 | 2 | 8 | 7 | 0 | 4 | 7 | 6182 | 5683 | 0.06 | 0.12 | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/smoke-m1-target-spacing-audcad-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_SMOKE_M1_TARGET_SPACING_AUDCAD_1W_2026-07-02.md`
