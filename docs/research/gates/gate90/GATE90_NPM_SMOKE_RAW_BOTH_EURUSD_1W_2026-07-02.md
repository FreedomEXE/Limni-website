...
Generated: `2026-07-02T02:39:03.934Z`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_RAW_BOTH | raw_both | EURUSD | ohlc_high_low | 1 | 1 | 9993.91 | -6.09 | 39.84 | -40.67 | -2.4 | -2.86 | 40 | 16 | 16 | 10 | -6.09 | 2 | 7 | 0 | 0 | 100 | 100 |
...
- summaryJson: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/npm-smoke-raw-both-eurusd-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_NPM_SMOKE_RAW_BOTH_EURUSD_1W_2026-07-02.md`
