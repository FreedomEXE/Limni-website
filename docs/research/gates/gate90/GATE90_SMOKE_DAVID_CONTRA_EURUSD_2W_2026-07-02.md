...
Generated: `2026-07-02T02:12:08.480Z`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_DAVID_CONTRA | david_contra | EURUSD | ohlc_high_low | 2 | 1 | 10021.95 | 21.95 | 30.6 | -0.53 | -1.98 | -6.14 | 33 | 1 | 16 | 10 | -34.52 | 2 | 5 | 21874 | 26168 | 0.01 | 0.02 |
...
| selected_week_count | 2 | >=1 | true |
| selected_pair_count | 1 | >=1 | true |

## Artifacts

- summaryJson: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/smoke-david-contra-eurusd-2w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_SMOKE_DAVID_CONTRA_EURUSD_2W_2026-07-02.md`
