...
Generated: `2026-07-02T16:39:07.141Z`
...
- summaryJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/close-events.rows.csv`
- terminalInventoryJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/terminal-inventory.rows.json`
- terminalInventoryCsv: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/terminal-inventory.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/gate90c-combined-variant-smoke-allpairs-1w/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90C_COMBINED_VARIANT_SMOKE_ALLPAIRS_1W_2026-07-02.md`
