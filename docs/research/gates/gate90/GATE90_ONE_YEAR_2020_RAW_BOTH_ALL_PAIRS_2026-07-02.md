...
Generated: `2026-07-02T02:19:27.039Z`
...
- Variant: `RAW_GRID_T100_S020_GATE90_RAW_BOTH`.
- Activation rule: `raw_both`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_RAW_BOTH | raw_both | AUDCAD,AUDCHF,AUDJPY,AUDNZD,AUDUSD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,EURUSD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,GBPUSD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDCAD,USDCHF,USDJPY | ohlc_high_low | 52 | 28 | -20707.57 | -30707.57 | 82782.41 | -96081.97 | -2659.08 | -14748.94 | 44318 | 2127 | 2169 | 237 | -57722.03 | 4135 | 4073 | 0 | 0 | 100 | 100 |
...
| activation_rule_id | raw_both | explicit | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/one-year-2020-raw_both/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_ONE_YEAR_2020_RAW_BOTH_ALL_PAIRS_2026-07-02.md`
