...
Generated: `2026-07-02T02:34:41.113Z`
...
- Variant: `RAW_GRID_T100_S020_GATE90_DAVID_STOCH_CONFIRM`.
- Activation rule: `david_stoch_confirm`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RAW_GRID_T100_S020_GATE90_DAVID_STOCH_CONFIRM | david_stoch_confirm | AUDCAD,AUDCHF,AUDJPY,AUDNZD,AUDUSD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,EURUSD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,GBPUSD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDCAD,USDCHF,USDJPY | ohlc_high_low | 52 | 28 | 10466.95 | 466.95 | 46989.65 | -39205.73 | -1537.56 | -5779.41 | 25626 | 947 | 1023 | 174 | -21214.34 | 2551 | 2297 | 16022042 | 15095697 | 0.02 | 0.02 |
...
| activation_rule_id | david_stoch_confirm | explicit | true |
...
- summaryJson: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/activation-summary.rows.json`
- summaryCsv: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/activation-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/weekly-activation-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/weekly-activation-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/close-events.rows.csv`
- validationJson: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/validation.rows.json`
- validationCsv: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/gate90-run-summary.json`
- shaManifest: `docs/research/gates/gate90/artifacts/one-year-2020-david_stoch_confirm/gate90-activation-sha256.txt`
- report: `docs/research/gates/gate90/GATE90_ONE_YEAR_2020_DAVID_STOCH_CONFIRM_ALL_PAIRS_2026-07-02.md`
