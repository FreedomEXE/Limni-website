...
Generated: `2026-07-01T22:42:50.361Z`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| EURUSD | ohlc_low_high | 312 | 1 | 11628.15 | 1628.15 | 11786.38 | -6613.43 | -420.12 | -3124.67 | 7002 | 161 | 186 | 156 | -5955.86 | 1453.64 |
...
| bar_path_mode | ohlc_low_high | explicit | true |
...
- summaryJson: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/continuous-truth-summary.rows.json`
- summaryCsv: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/continuous-truth-summary.rows.csv`
- weeklyJson: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/weekly-continuous-truth.rows.json`
- weeklyCsv: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/weekly-continuous-truth.rows.csv`
- closeEventsJson: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/close-events.rows.json`
- closeEventsCsv: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/close-events.rows.csv`
- validationJson: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/validation.rows.json`
- validationCsv: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/validation.rows.csv`
- metricDefinitionsJson: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/metric-definitions.rows.json`
- metricDefinitionsCsv: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/metric-definitions.rows.csv`
- commandReceipt: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/command-receipt.json`
- runSummaryJson: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/gate89-run-summary.json`
- shaManifest: `docs/research/gates/gate89/artifacts/continuous-raw-truth-eurusd-ohlc-low-high/gate89-continuous-truth-sha256.txt`
- report: `docs/research/gates/gate89/GATE89_CONTINUOUS_RAW_TRUTH_SIMULATOR_EURUSD_OHLC_LOW_HIGH_2026-07-01.md`
