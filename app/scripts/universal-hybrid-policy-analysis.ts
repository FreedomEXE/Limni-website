...
async function main() {
  ...
  const jsonPath = `app/reports/universal-hybrid-policy-analysis-${stamp}.json`;
  const mdPath = `app/reports/universal-hybrid-policy-analysis-${stamp}.md`;
  const latestJson = "app/reports/universal-hybrid-policy-analysis-latest.json";
  const latestMd = "app/reports/universal-hybrid-policy-analysis-latest.md";
