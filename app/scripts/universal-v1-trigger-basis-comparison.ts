...
async function main() {
  ...
  const jsonPath = `app/reports/universal-v1-trigger-basis-comparison-${stamp}.json`;
  const mdPath = `app/reports/universal-v1-trigger-basis-comparison-${stamp}.md`;
  const latestJson = "app/reports/universal-v1-trigger-basis-comparison-latest.json";
  const latestMd = "app/reports/universal-v1-trigger-basis-comparison-latest.md";
