 ...
 * database/contracts/mt5_event_contract.json.
 */
/*-----------------------------------------------
...
const CONTRACT_PATH = path.resolve(ROOT, "database/contracts/mt5_event_contract.json");
const TS_OUT = path.resolve(ROOT, "app/src/lib/mt5/contracts.ts");
const MQH_OUT = path.resolve(ROOT, "app/services/mt5/Experts/Include/Generated/Contract.mqh");
 ...
 *
 * Description:
 * AUTO-GENERATED FROM database/contracts/mt5_event_contract.json.
...
function buildMqh(spec: ContractSpec): string {
  ...
  lines.push("-----------------------------------------------*/");
  lines.push("// AUTO-GENERATED FROM database/contracts/mt5_event_contract.json - DO NOT EDIT MANUALLY");
