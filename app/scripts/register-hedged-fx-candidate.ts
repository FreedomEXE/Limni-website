...
const REPORT_LATEST_JSON = "app/reports/eightcap-3k-hedged-fx-weekly-sweep-latest.json";
const REGISTRY_PATH = "Local Environment/data/research_strategy_candidates.json";
...
function main() {
  ...
  const candidate: CandidateRecord = {
    ...
    source_artifacts: {
      script: "app/scripts/eightcap-3k-hedged-fx-weekly-sweep.ts",
      report_latest_json: "app/reports/eightcap-3k-hedged-fx-weekly-sweep-latest.json",
      report_latest_md: "app/reports/eightcap-3k-hedged-fx-weekly-sweep-latest.md",
      recent_raw_runs: [
