...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-100k-5week-universal-vs-tiered-${stamp}.json`;
  const mdPath = `app/reports/eightcap-100k-5week-universal-vs-tiered-${stamp}.md`;
  const latestJsonPath = "app/reports/eightcap-100k-5week-universal-vs-tiered-latest.json";
  const latestMdPath = "app/reports/eightcap-100k-5week-universal-vs-tiered-latest.md";
