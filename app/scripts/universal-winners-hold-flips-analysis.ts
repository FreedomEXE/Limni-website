...
async function main() {
  ...
  const jsonPath = `app/reports/universal-winners-hold-flips-analysis-${stamp}.json`;
  const mdPath = `app/reports/universal-winners-hold-flips-analysis-${stamp}.md`;
  const latestJsonPath = "app/reports/universal-winners-hold-flips-analysis-latest.json";
  const latestMdPath = "app/reports/universal-winners-hold-flips-analysis-latest.md";
