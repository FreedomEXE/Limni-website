...
async function main() {
  ...
  const jsonPath = `app/reports/universal-v1-weekly-adds-comparison-${stamp}.json`;
  const mdPath = `app/reports/universal-v1-weekly-adds-comparison-${stamp}.md`;
  const latestJson = "app/reports/universal-v1-weekly-adds-comparison-latest.json";
  const latestMd = "app/reports/universal-v1-weekly-adds-comparison-latest.md";
