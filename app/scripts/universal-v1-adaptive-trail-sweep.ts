...
async function main() {
  ...
  const jsonPath = `app/reports/universal-v1-adaptive-trail-sweep-${stamp}.json`;
  const mdPath = `app/reports/universal-v1-adaptive-trail-sweep-${stamp}.md`;
  const latestJson = "app/reports/universal-v1-adaptive-trail-sweep-latest.json";
  const latestMd = "app/reports/universal-v1-adaptive-trail-sweep-latest.md";
