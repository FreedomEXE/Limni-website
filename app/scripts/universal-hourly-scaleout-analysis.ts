...
async function main() {
  ...
  const jsonPath = `app/reports/universal-hourly-scaleout-analysis-${stamp}.json`;
  const mdPath = `app/reports/universal-hourly-scaleout-analysis-${stamp}.md`;
  const latestJsonPath = "app/reports/universal-hourly-scaleout-analysis-latest.json";
  const latestMdPath = "app/reports/universal-hourly-scaleout-analysis-latest.md";
