...
async function main() {
  ...
  const jsonPath = `app/reports/universal-v3-agreement-backtest-${stamp}.json`;
  const mdPath = `app/reports/universal-v3-agreement-backtest-${stamp}.md`;
  const latestJsonPath = "app/reports/universal-v3-agreement-backtest-latest.json";
  const latestMdPath = "app/reports/universal-v3-agreement-backtest-latest.md";
