...
async function main() {
  ...
  const jsonPath = `app/reports/v1-universal-tp1-friday-carry-aligned-${stamp}.json`;
  const latestJsonPath = "app/reports/v1-universal-tp1-friday-carry-aligned-latest.json";
  const mdPath = `app/reports/v1-universal-tp1-friday-carry-aligned-${stamp}.md`;
  const latestMdPath = "app/reports/v1-universal-tp1-friday-carry-aligned-latest.md";
