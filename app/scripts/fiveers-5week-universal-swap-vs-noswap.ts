...
const WEEKS_SOURCE_PATH = "app/reports/eightcap-3k-5week-floor-clamped-compare-latest.json";
...
async function main() {
  ...
  const jsonPath = `app/reports/fiveers-5week-universal-swap-vs-noswap-${stamp}.json`;
  const mdPath = `app/reports/fiveers-5week-universal-swap-vs-noswap-${stamp}.md`;
  const latestJsonPath = "app/reports/fiveers-5week-universal-swap-vs-noswap-latest.json";
  const latestMdPath = "app/reports/fiveers-5week-universal-swap-vs-noswap-latest.md";
