...
async function main() {
  ...
  const jsonPath = `app/reports/universal-breakout-overlay-phase1-${stamp}.json`;
  const mdPath = `app/reports/universal-breakout-overlay-phase1-${stamp}.md`;
  const latestJson = "app/reports/universal-breakout-overlay-phase1-latest.json";
  const latestMd = "app/reports/universal-breakout-overlay-phase1-latest.md";
