...
async function main() {
  ...
  const jsonPath = `app/reports/universal-v1-funded-policy-sim-${stamp}.json`;
  const mdPath = `app/reports/universal-v1-funded-policy-sim-${stamp}.md`;
  const latestJson = "app/reports/universal-v1-funded-policy-sim-latest.json";
  const latestMd = "app/reports/universal-v1-funded-policy-sim-latest.md";
