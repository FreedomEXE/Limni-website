 ...
 *
 * Description:
 * Whitepaper-style bot profile for the Katarakti CFD branch.
 */
/*-----------------------------------------------
...
export default async function Mt5ForexBotPage() {
  const entry = getAutomationBotEntryById("katarakti-cfd");
  if (!entry) return null;

  return (
    <DashboardLayout>
      <div className="space-y-6">
        <AutomationBotsCards active="mt5-forex" />
