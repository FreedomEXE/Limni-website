  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-[var(--panel-border)] bg-[var(--panel)] p-4 text-xs text-[color:var(--muted)] shadow-sm">
        ...
        <p className="mt-2">
          Sweep requires range breach ({">="}0.1%). After breach, price must dwell outside range for 3 consecutive
          minutes, then re-enter on the first close back inside range.
        </p>
        <p className="mt-1">
          Re-entry candle close must be in the lower 40% of the candle range (SHORT) or upper 40% (LONG).
          No displacement or handshake confirmation is required.
        </p>
        <p className="mt-1">Weekly bias filtering remains active.</p>
      </div>
