...
**Primary report:** `app/reports/dealer-commercial-quality-backtest-latest.json`

## What changed

- Historical quality backtest crypto pricing was switched from Bitget to OANDA in `app/scripts/backtest-dealer-commercial-quality.ts`.
- Run windows:
...
- `app/reports/dealer-commercial-quality-backtest-latest.json`
- `app/reports/dealer-commercial-quality-backtest-2026-02-20_235931.json`
- `app/scripts/backtest-dealer-commercial-quality.ts`
