...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-path", default="app/research/scalp_bot/output/liq_sweep_signals.csv")
    parser.add_argument("--multi-output-path", default="app/research/scalp_bot/output/liq_sweep_multi_offset.csv")
