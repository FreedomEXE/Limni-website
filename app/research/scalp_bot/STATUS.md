...
## Scope status
- Built research/backtest module under `app/research/scalp_bot/` with CLI, reports, plots, audit charts, and tests.
- Added daily bias tester (COT-only) and published results to `app/public/scalp-bot/`.
...
- Sanity checks: in `app/research/scalp_bot/sanity.py`.
...
- Outputs per mode:
  ...
  - Published to `app/public/scalp-bot/daily_bias_{mode}/`

### UI integration
- `app/src/app/automation/page.tsx`:
...
- Data loaders in `app/src/lib/scalpBot.ts` updated to load daily bias by mode.
...
## Key code paths
- Daily bias engine: `app/research/scalp_bot/daily_bias.py`
- Scalp bot runner: `app/research/scalp_bot/run.py`
- Download helper: `app/research/scalp_bot/download.py`
- COT backfill: `app/research/scalp_bot/backfill_cot.py`
- Stage 3 grid tools: `app/research/scalp_bot/grid_small.py`, `app/research/scalp_bot/run_top_configs.py`
- Automation UI: `app/src/app/automation/page.tsx`
- Data loader: `app/src/lib/scalpBot.ts`
