...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="app/research/scalp_bot/output_daily_bias")
    parser.add_argument("--publish", action="store_true")
    parser.add_argument("--publish-dir", default="app/public/scalp-bot/daily_bias")
