...
def build_config(args) -> tuple[BacktestConfig, DataConfig]:
    ...
    if not spread_path.exists():
        alt = Path("app/research/scalp_bot/spread_config.json")
        if alt.exists():
            spread_path = alt
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="app/research/scalp_bot/output")
    ...
    parser.add_argument("--pairs-source", default="app/src/lib/cotPairs.ts")
    ...
    parser.add_argument("--publish-dir", default="app/public/scalp-bot")
