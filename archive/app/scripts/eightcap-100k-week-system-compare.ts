...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-100k-system-compare-week-${stamp}.json`;
  const mdPath = `app/reports/eightcap-100k-system-compare-week-${stamp}.md`;
  const latestJsonPath = "app/reports/eightcap-100k-system-compare-week-latest.json";
  const latestMdPath = "app/reports/eightcap-100k-system-compare-week-latest.md";
