...
async function main() {
  ...
  const jsonPath = `app/reports/universal-v1-policy-analysis-${stamp}.json`;
  const mdPath = `app/reports/universal-v1-policy-analysis-${stamp}.md`;
  const latestJson = "app/reports/universal-v1-policy-analysis-latest.json";
  const latestMd = "app/reports/universal-v1-policy-analysis-latest.md";
