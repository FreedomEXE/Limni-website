...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-3k-hedged-fx-weekly-sweep-${stamp}.json`;
  const latestJsonPath = "app/reports/eightcap-3k-hedged-fx-weekly-sweep-latest.json";
  const mdPath = `app/reports/eightcap-3k-hedged-fx-weekly-sweep-${stamp}.md`;
  const latestMdPath = "app/reports/eightcap-3k-hedged-fx-weekly-sweep-latest.md";
