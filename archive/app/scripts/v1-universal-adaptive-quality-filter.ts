...
async function main() {
  ...
  const jsonPath = `app/reports/v1-universal-adaptive-quality-filter-${stamp}.json`;
  const latestJsonPath = "app/reports/v1-universal-adaptive-quality-filter-latest.json";
  const mdPath = `app/reports/v1-universal-adaptive-quality-filter-${stamp}.md`;
  const latestMdPath = "app/reports/v1-universal-adaptive-quality-filter-latest.md";
