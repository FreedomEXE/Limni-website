...
async function main() {
  ...
  const jsonPath = `app/reports/universal-deep-analysis-${stamp}.json`;
  const mdPath = `app/reports/universal-deep-analysis-${stamp}.md`;
  const latestJsonPath = "app/reports/universal-deep-analysis-latest.json";
  const latestMdPath = "app/reports/universal-deep-analysis-latest.md";
