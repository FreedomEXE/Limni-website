...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-100k-v3-tier-test-${stamp}.json`;
  const mdPath = `app/reports/eightcap-100k-v3-tier-test-${stamp}.md`;
  const latestJsonPath = "app/reports/eightcap-100k-v3-tier-test-latest.json";
  const latestMdPath = "app/reports/eightcap-100k-v3-tier-test-latest.md";
