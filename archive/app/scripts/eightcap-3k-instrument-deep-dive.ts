...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-3k-instrument-deep-dive-${stamp}.json`;
  const mdPath = `app/reports/eightcap-3k-instrument-deep-dive-${stamp}.md`;
  const latestJsonPath = "app/reports/eightcap-3k-instrument-deep-dive-latest.json";
  const latestMdPath = "app/reports/eightcap-3k-instrument-deep-dive-latest.md";
