...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-100k-5week-system-compare-${stamp}.json`;
  const mdPath = `app/reports/eightcap-100k-5week-system-compare-${stamp}.md`;
  const latestJsonPath = "app/reports/eightcap-100k-5week-system-compare-latest.json";
  const latestMdPath = "app/reports/eightcap-100k-5week-system-compare-latest.md";
