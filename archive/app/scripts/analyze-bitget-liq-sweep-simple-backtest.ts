...
async function main() {
  ...
  const reportPath = path.resolve(process.cwd(), "app/reports/bitget-liq-sweep-simple-latest.txt");
  ...
  if (jsonReport) {
    const jsonPath = path.resolve(process.cwd(), "app/reports/bitget-liq-sweep-simple-latest.json");
