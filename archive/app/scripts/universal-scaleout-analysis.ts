...
async function main() {
  ...
  const jsonPath = `app/reports/universal-scaleout-analysis-${stamp}.json`;
  const mdPath = `app/reports/universal-scaleout-analysis-${stamp}.md`;
  const latestJsonPath = "app/reports/universal-scaleout-analysis-latest.json";
  const latestMdPath = "app/reports/universal-scaleout-analysis-latest.md";
