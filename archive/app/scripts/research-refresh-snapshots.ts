...
async function main() {
  ...
  writeFileSync("Local Environment/data/research_cot_snapshots.json", JSON.stringify(output, null, 2));
  writeFileSync("Local Environment/data/research_sentiment_aggregates.json", JSON.stringify(sentimentAggregates, null, 2));
