...
const CLOSE_LOCATION_VALUES = (process.env.BITGET_LITE_CLOSE_LOC_VALUES ?? "0.35,0.40,0.45")
  ...
  .sort((a, b) => a - b);
const REPORT_PATH = path.join(process.cwd(), "app", "reports", "bitget-lite-entry-latest.txt");
const JSON_REPORT_PATH = path.join(process.cwd(), "app", "reports", "bitget-lite-entry-latest.json");
