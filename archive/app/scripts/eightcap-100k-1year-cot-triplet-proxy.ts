...
async function main() {
  ...
  const jsonPath = `app/reports/eightcap-100k-1year-cot-triplet-proxy-${stamp}.json`;
  const mdPath = `app/reports/eightcap-100k-1year-cot-triplet-proxy-${stamp}.md`;
  const latestJsonPath = "app/reports/eightcap-100k-1year-cot-triplet-proxy-latest.json";
  const latestMdPath = "app/reports/eightcap-100k-1year-cot-triplet-proxy-latest.md";
