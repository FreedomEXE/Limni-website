  ...
  if (accounts.length === 0) {
    return (
      <div className="rounded-2xl border border-dashed border-[var(--panel-border)] bg-[var(--panel)]/70 p-6 text-sm text-[color:var(--muted)]">
        No MT5 accounts connected yet. Add the push URL and token in your EA
        ...
        >
          ...
          <Link href={`/accounts/${account.account_id}`} className="block">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs">
              ...
              >
                Win {account.win_rate_pct.toFixed(1)}%
              </span>
              <span
                className={`rounded-full border px-3 py-1 ${pillTone(
