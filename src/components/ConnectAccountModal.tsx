...
const MT5_DOWNLOAD_FILES: Mt5DownloadFile[] = [
  {
    ...
    instructions: [
      ...
      "In Tools > Options > Expert Advisors, add the Limni API URL to allowed WebRequest URLs.",
      "Leave MT5 running and confirm successful pushes in the Experts tab logs.",
    ],
  },
  {
    key: "sizer",
    title: "Sizing Script Analyzer",
    fileName: "LimniSizingAudit.ex5",
    href: "/downloads/LimniSizingAudit.ex5",
    instructions: [
      "In MT5, copy LimniSizingAudit.ex5 into MQL5/Scripts.",
      "Restart MT5 or right-click Navigator > Scripts > Refresh.",
      "Drag the script onto any chart when you want a sizing audit snapshot.",
