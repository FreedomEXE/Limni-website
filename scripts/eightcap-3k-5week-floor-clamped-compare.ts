...
async function main() {
  ...
  const jsonPath = `reports/eightcap-3k-5week-floor-clamped-compare-${stamp}.json`;
  const mdPath = `reports/eightcap-3k-5week-floor-clamped-compare-${stamp}.md`;
  const latestJsonPath = "reports/eightcap-3k-5week-floor-clamped-compare-latest.json";
  const latestMdPath = "reports/eightcap-3k-5week-floor-clamped-compare-latest.md";
