...
async function main() {
  ...
  const jsonPath = `reports/eightcap-100k-1year-cot-only-universal-vs-tiered-${stamp}.json`;
  const mdPath = `reports/eightcap-100k-1year-cot-only-universal-vs-tiered-${stamp}.md`;
  const latestJsonPath = "reports/eightcap-100k-1year-cot-only-universal-vs-tiered-latest.json";
  const latestMdPath = "reports/eightcap-100k-1year-cot-only-universal-vs-tiered-latest.md";
