...
const CACHE_DIR = path.join(process.cwd(), ".cache", "manual-session-matrix");
...
const KATARAKTI_REPORT_PATH = path.join(process.cwd(), "reports", "katarakti-phase1-backtest-latest.json");
