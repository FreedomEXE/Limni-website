...
$summary.Add("MetaEditor exit code note: exit_code=1 can be clean in this local setup when the compile result line reports 0 errors, 0 warnings; clean=True is the gate signal.")
