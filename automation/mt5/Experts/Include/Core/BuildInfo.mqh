/*-----------------------------------------------
  LimniPortfolioEA Revma state harvest harness
  Gate 107A
-----------------------------------------------*/
...
const string LP_EA_VERSION = "0.1.22-gate107a-tpsep";
const string LP_BUILD_GATE = "Gate107A";
const string LP_BUILD_SCOPE = "revma-state-harvest-tp-layer-separation-repair";
